...
Keep **Skip Reward Queue disabled** on all five Twitch rewards. First Five can safely accept a valid already-fulfilled redemption, but Twitch cannot refund an already-fulfilled repeat or out-of-order redemption.

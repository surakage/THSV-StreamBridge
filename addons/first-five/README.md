...
Import `packages/streamerbot/first-five/THSV-StreamBridge-First-Five-1.0.0.sb`. Keep **THSV Addon - First Five - Controller** triggerless and approve only that stable action ID for this add-on. The optional Reset action may be attached to a deck button or hotkey.

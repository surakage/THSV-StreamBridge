...
2. Import `THSV-StreamBridge-Village-Jukebox-2.6.0.sb` into Streamer.bot.
...
5. Generate the six no-response Jukebox command templates in Command Sync and enable the commands you want.

...
const manifest = {
  ...
  maximumTestedCoreVersion: '2.0.0-preview.1', minimumBridgeVersion: '4.0.1', maximumTestedBridgeVersion: '4.0.1',
  dependencies: [],
  ...
  installationSteps: [
    ...
    'Import the bundled Streamer.bot/THSV-StreamBridge-Subathon-Timer-4.0.1.sb package for Start, Pause, Resume, Reset, and Add Time actions.',

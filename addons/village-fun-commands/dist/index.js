...
const manifest = {
  contractVersion:'2.0.0-preview.1', moduleId:MODULE_ID, name:'Village Fun Commands', version:'4.0.7', minimumCoreVersion:'2.0.0-preview.1', maximumTestedCoreVersion:'2.0.0-preview.1', minimumBridgeVersion: '4.0.7', maximumTestedBridgeVersion: '4.0.7', dependencies:[], requiredCapabilities:[], configurationSchema:'schemas/config.json',

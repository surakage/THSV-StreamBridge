...
const manifest = {
  contractVersion:'2.0.0-preview.1', moduleId:MODULE_ID, name:'Village Fun Commands', version:'3.6.0', minimumCoreVersion:'2.0.0-preview.1', maximumTestedCoreVersion:'2.0.0-preview.1', minimumBridgeVersion: '3.6.0', maximumTestedBridgeVersion: '3.6.0', dependencies:[], requiredCapabilities:[], configurationSchema:'schemas/config.json',

...
const manifest = {
  contractVersion: '2.0.0-preview.1', moduleId: MODULE_ID, name: 'Free Game Check', version: '4.0.10',
  minimumCoreVersion: '2.0.0-preview.1', maximumTestedCoreVersion: '2.0.0-preview.1', minimumBridgeVersion: '4.0.10', maximumTestedBridgeVersion: '4.0.10', dependencies: ['thsv.viewer-foundation'], requiredCapabilities: [],

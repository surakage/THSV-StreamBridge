...
3. Import `THSV-StreamBridge-Chat-Play-Pack-3.6.0.sb` only when using the optional OpenTDB or Dictionary provider actions. Viewer commands already use the main chat intakes.

...
3. Import `THSV-StreamBridge-Chat-Play-Pack-4.0.12.sb` only when using the optional OpenTDB or Dictionary provider actions. Viewer commands already use the main chat intakes.

...
1. Download and extract `THSV-StreamBridge-AddOn-Automated-Shoutouts-1.1.0.zip`, then install its `THSV-Automated-Shoutouts-4.0.0.thsv-addon` through the authenticated wizard and enable it.

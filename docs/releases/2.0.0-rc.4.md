...
Download `THSV-StreamBridge-2.0.0-rc.4-windows-x64.zip` and its `.sha256` file from this release, verify them using `RELEASE-VERIFICATION.md`, extract the archive, and run `Install THSV StreamBridge.cmd`.

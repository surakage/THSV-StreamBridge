...
1. Download and extract `THSV-StreamBridge-AddOn-Subathon-Timer-4.0.10.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Subathon-Timer-4.0.10.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Subathon-Timer-4.0.10.sb` in Streamer.bot.
...
3. Import the bundled Streamer.bot/THSV-StreamBridge-Subathon-Timer-4.0.10.sb package for Start, Pause, Resume, Reset, and Add Time actions.
...
- Optionally attach these controls to hotkeys, deck buttons, or scene-active/scene-inactive triggers.

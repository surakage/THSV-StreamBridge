...
2. In **Setup Wizard > Add-ons**, install `THSV-Subathon-Timer-3.6.0.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Subathon-Timer-3.6.0.sb` in Streamer.bot.
...
3. Import the bundled Streamer.bot/THSV-StreamBridge-Subathon-Timer-3.6.0.sb package for Start, Pause, Resume, Reset, and Add Time actions.

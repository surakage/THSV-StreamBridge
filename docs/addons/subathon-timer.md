...
2. In **Setup Wizard > Add-ons**, install `THSV-Subathon-Timer-4.0.7.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Subathon-Timer-4.0.7.sb` in Streamer.bot.
...
3. Import the bundled Streamer.bot/THSV-StreamBridge-Subathon-Timer-4.0.7.sb package for Start, Pause, Resume, Reset, and Add Time actions.

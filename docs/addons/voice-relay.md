...
1. Download and extract `THSV-StreamBridge-AddOn-Village-Voice-3.0.0.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Village-Voice-3.0.0.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Voice-Relay-3.0.0.sb` in Streamer.bot.

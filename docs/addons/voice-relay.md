...
2. In **Setup Wizard > Add-ons**, install `THSV-Village-Voice-4.0.4.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Voice-Relay-4.0.4.sb` in Streamer.bot.

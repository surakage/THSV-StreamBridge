...
2. In **Setup Wizard > Add-ons**, install `THSV-Clip-Library-Cache-4.0.5.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Clip-Library-Cache-4.0.5.sb` in Streamer.bot.

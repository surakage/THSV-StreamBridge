...
2. In **Setup Wizard > Add-ons**, install `THSV-Custom-Counter-3.5.0.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Custom-Counter-3.5.0.sb` in Streamer.bot.

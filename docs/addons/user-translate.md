...
1. Download and extract `THSV-StreamBridge-AddOn-User-Translate-2.5.0.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-User-Translate-2.5.0.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-User-Translate-2.5.0.sb` in Streamer.bot.

...
2. In **Setup Wizard > Add-ons**, install `THSV-Translate-4.0.1.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-User-Translate-4.0.1.sb` in Streamer.bot.

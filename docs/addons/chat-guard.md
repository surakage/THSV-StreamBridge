...
1. Download and extract `THSV-StreamBridge-AddOn-Chat-Guard-4.0.1.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Chat-Guard-4.0.10.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Chat-Guard-4.0.10.sb` in Streamer.bot.

...
2. In **Setup Wizard > Add-ons**, install `THSV-Chat-Guard-4.0.7.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Chat-Guard-4.0.7.sb` in Streamer.bot.

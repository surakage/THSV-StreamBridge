...
1. Download and extract `THSV-StreamBridge-AddOn-Chat-Play-Pack-2.5.1.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Chat-Play-Pack-2.5.1.thsv-addon` and review its permissions.

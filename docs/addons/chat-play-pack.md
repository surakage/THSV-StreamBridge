...
2. In **Setup Wizard > Add-ons**, install `THSV-Chat-Play-Pack-4.0.2.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Chat-Play-Pack-4.0.2.sb` in Streamer.bot.

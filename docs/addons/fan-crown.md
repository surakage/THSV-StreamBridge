...
2. In **Setup Wizard > Add-ons**, install `THSV-Fan-Crown-4.0.8.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Fan-Crown-4.0.8.sb` in Streamer.bot.

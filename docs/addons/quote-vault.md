...
2. In **Setup Wizard > Add-ons**, install `THSV-Quote-Vault-4.0.9.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Quote-Vault-4.0.9.sb` in Streamer.bot.

...
1. Download and extract `THSV-StreamBridge-AddOn-Discord-Chat-Archive-2.5.2.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Discord-Chat-Archive-2.5.2.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Discord-Chat-Archive-2.5.2.sb` in Streamer.bot.

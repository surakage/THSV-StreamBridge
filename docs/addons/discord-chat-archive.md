...
2. In **Setup Wizard > Add-ons**, install `THSV-Discord-Chat-Archive-4.0.7.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Discord-Chat-Archive-4.0.7.sb` in Streamer.bot.

...
1. Download and extract `THSV-StreamBridge-AddOn-Free-Game-Check-4.0.10.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Free-Game-Check-4.0.10.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Free-Game-Check-4.0.10.sb` in Streamer.bot.

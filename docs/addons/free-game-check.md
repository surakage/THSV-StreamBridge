...
2. In **Setup Wizard > Add-ons**, install `THSV-Free-Game-Check-4.0.11.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Free-Game-Check-4.0.11.sb` in Streamer.bot.

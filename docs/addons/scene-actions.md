...
2. In **Setup Wizard > Add-ons**, install `THSV-Scene-Actions-4.0.6.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Scene-Actions-4.0.6.sb` in Streamer.bot.

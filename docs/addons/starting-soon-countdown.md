...
2. In **Setup Wizard > Add-ons**, install `THSV-Stream-Launch-Countdown-4.0.5.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Stream-Launch-Countdown-4.0.5.sb` in Streamer.bot.

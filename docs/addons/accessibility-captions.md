...
1. Download and extract `THSV-StreamBridge-AddOn-Accessibility-Captions-3.5.0.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Accessibility-Captions-3.5.0.thsv-addon` and review its permissions.

...
1. Download and extract `THSV-StreamBridge-AddOn-Viewer-Foundation-2.6.0.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Viewer-Foundation-2.6.0.thsv-addon` and review its permissions.

...
3. Choose point awards and cooldowns, save, and restart StreamBridge.
...
- **thsv.viewer-foundation.runtime:** Confirms salted identity resolution, bounded replay protection, and atomic private progression state.

## Data and permissions

Package kind: **executable**. Requested permissions: `events.subscribe`, `state.private`, `viewer.foundation.provide`.

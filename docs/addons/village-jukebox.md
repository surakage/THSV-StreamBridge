...
1. Download and extract `THSV-StreamBridge-AddOn-Village-Jukebox-4.0.11.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Village-Jukebox-4.0.12.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Village-Jukebox-4.0.12.sb` in Streamer.bot.

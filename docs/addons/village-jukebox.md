...
2. In **Setup Wizard > Add-ons**, install `THSV-Village-Jukebox-4.0.9.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Village-Jukebox-4.0.9.sb` in Streamer.bot.

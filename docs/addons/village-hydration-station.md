...
2. In **Setup Wizard > Add-ons**, install `THSV-Village-Hydration-Station-4.0.5.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Village-Hydration-Station-4.0.5.sb` in Streamer.bot.

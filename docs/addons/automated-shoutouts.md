...
2. In **Setup Wizard > Add-ons**, install `THSV-Automated-Shoutouts-4.0.9.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Automated-Shoutouts-4.0.9.sb` in Streamer.bot.

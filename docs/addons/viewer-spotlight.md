...
1. Download and extract `THSV-StreamBridge-AddOn-Viewer-Spotlight-3.5.0.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Viewer-Spotlight-3.5.0.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Viewer-Spotlight-3.5.0.sb` in Streamer.bot.

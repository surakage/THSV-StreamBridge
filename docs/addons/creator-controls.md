...
2. In **Setup Wizard > Add-ons**, install `THSV-Creator-Controls-4.0.2.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Creator-Controls-4.0.2.sb` in Streamer.bot.

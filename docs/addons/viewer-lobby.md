...
2. In **Setup Wizard > Add-ons**, install `THSV-Viewer-Lobby-4.0.4.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Viewer-Lobby-4.0.4.sb` in Streamer.bot.

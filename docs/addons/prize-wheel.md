...
1. Download and extract `THSV-StreamBridge-AddOn-Prize-Wheel-4.0.10.zip` from the same GitHub release as StreamBridge.
2. In **Setup Wizard > Add-ons**, install `THSV-Prize-Wheel-4.0.10.thsv-addon` and review its permissions.

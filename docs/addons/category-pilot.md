...
2. In **Setup Wizard > Add-ons**, install `THSV-Category-Pilot-3.6.0.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Category-Pilot-3.6.0.sb` in Streamer.bot.

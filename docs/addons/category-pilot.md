...
2. In **Setup Wizard > Add-ons**, install `THSV-Category-Pilot-4.0.3.thsv-addon` and review its permissions.
3. Import `Streamer.bot/THSV-StreamBridge-Category-Pilot-4.0.3.sb` in Streamer.bot.

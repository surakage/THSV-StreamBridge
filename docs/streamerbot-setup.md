...
12. Import `packages\streamerbot\companion-actions\THSV-StreamBridge-Bloom-Companion-1.0.0.sb` and add it as another immediate receiver child action. It handles only derived `companion.action` events.

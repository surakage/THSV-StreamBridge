...
16. Import `packages\streamerbot\native-platform-intake\THSV-StreamBridge-Native-Platform-Intake-1.5.0.sb`. It installs one intake action each for Twitch, YouTube, and Kick in separate platform groups.

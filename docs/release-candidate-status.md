...
Snapshot: August 2, 2026. Published release: `3.0.0`.
...
| Automated validation | Published Version 3 gates passed. The current post-release tree also passes typecheck, lint, build, `148` Vitest files / `844` tests, `18` Playwright tests, and zero known npm vulnerabilities. |
...
## Validated after the 3.0.0 release
...
- These post-release changes pass the automated gates above but are not part of the installed or published `3.0.0` archive until a new release is packaged and installed.

...
- **Post-completion trust hardening.** Enable/Disable is restricted to commands in the persisted
  ...
  role value as reference metadata, not an enforced Streamer.bot permission, and discloses that
  generated commands default to Twitch chat until the creator selects other sources after import.

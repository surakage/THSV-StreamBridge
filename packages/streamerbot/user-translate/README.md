...
Import `THSV-StreamBridge-User-Translate-3.6.0.sb`, compile the one action with the references in `manifest.json`, and approve `THSV Addon - Translate - Translate Text` for `thsv.user-translate` in the wizard.

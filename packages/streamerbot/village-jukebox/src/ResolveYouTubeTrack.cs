...
public class CPHInline
{
    ...
    {
        var request = (HttpWebRequest)WebRequest.Create(url); request.Method = "GET"; request.Accept = "application/json"; request.UserAgent = "THSV-StreamBridge-Village-Jukebox/4.0.1"; request.Timeout = 10000; request.ReadWriteTimeout = 10000;

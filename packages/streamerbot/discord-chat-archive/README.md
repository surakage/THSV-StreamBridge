...
2. Import `THSV-StreamBridge-Discord-Chat-Archive-4.0.10.sb`.
...
7. Run the action manually once. With no bridge arguments, it sends a safe normal-channel setup test containing no viewer data.

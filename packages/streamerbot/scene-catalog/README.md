...
Import `THSV-StreamBridge-Scene-Catalog-4.0.4.sb` with the universal importer. The wizard invokes this exact action ID through Streamer.bot's already-authenticated local WebSocket connection.

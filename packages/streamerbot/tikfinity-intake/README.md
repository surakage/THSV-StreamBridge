...
This package installs four consistently named actions in the `THSV StreamBridge - TikTok` group: `THSV TikTok - Chat`, `THSV TikTok - Follow`, `THSV TikTok - Gift`, and `THSV TikTok - Like`.

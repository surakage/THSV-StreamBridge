...
2. Drag `THSV-StreamBridge-Core-Receiver-4.0.2.sb` into the import field, or paste the file contents.
...
For each adopted stable Streamer.bot release, recompile the receiver and rerun the manual QA matrix below. Current THSV 4.0.2 imports require Streamer.bot 1.0.6 stable or later because 1.0.6 fixes the critical Twitch Custom Channel Rewards crash in 1.0.5.

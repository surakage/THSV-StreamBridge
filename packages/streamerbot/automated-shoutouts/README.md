...
This optional package contains two triggerless actions:
...
The native action requires only `mscorlib.dll` and `System.dll`. Platform-colored profile and welcome cards are rendered by StreamBridge's existing hosted overlay; this package never retrieves or plays clips.

...
Import `THSV-StreamBridge-Bloom-Companion-1.1.0.sb` after Core Receiver `1.0.4` or newer. Add **Run Action Immediately** for `THSV StreamBridge - Bloom Companion` after the receiver.

...
describe('wizard launcher package', () => {
  ...
  it('announces asynchronous results and supports a persistent system-aware color theme', async () => {
    ...
    expect(shell.match(/aria-live="polite"/g)).toHaveLength(19);
    expect(shell.match(/role="status"/g)).toHaveLength(18);
    ...
    expect(addOnScript).toContain('Current activity');
    expect(addOnScript).toContain('Recent completed sessions');

...
describe('release evidence manifest', () => {
  it('records exact asset hashes plus lifecycle and startup evidence', async () => {
    ...
    await writeFile(lifecycle, JSON.stringify({ currentTag: 'v4.0.3', previousTag: 'v4.0.2', creatorDataPreserved: true, encryptedRecoveryBundleVerified: true, recoveryFreshProfileRestored: true }), 'utf8');

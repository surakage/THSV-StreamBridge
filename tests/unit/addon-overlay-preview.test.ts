...
describe('hosted add-on overlay previews', () => {
  it('uses Viewer Spotlight appearance and selected fake public fields without production viewer data', () => {
    const preview = buildAddOnOverlayPreview({
      ...
      settings: { showPlatformBadge: false, showPoints: true, showLevel: false, showObservedSessions: true, showObservedMessages: true, showObservedCommands: false, showEngagementScore: true, showSeasonRank: true, durationSeconds: 14, backgroundMode: 'solid', backgroundColor: '#102030', backgroundOpacity: 0.7, accentColor: '#abcdef', textColor: '#fedcba', fontFamily: 'serif' },
    });

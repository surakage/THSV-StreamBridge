...
- Clarified that the observed Streamer.bot `Partially Connected (8/10)` state is caused only by intentionally unused Meld and Speaker.bot connections; OBS and the integrations required by the current add-on set are connected.
